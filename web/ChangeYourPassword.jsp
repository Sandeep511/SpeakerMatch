<%-- 
    Document   : ChangeYourPassword
    Created on : Feb 17, 2016, 10:09:45 AM
    Author     : Rajeev
--%>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div>
            <input type="text" class="form-control" name="Password1" value="<%=rs.getString("pasword1")%>" placeholder="Password" required=""/>
        </div>
        <div>
